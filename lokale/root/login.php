...
$loginCheck="SELECT * FROM Bruger WHERE Navn = '{$email}' AND Password = '{$passwordLogin}' AND Klasse = '{$Klasse}'"; /*Making an sql-query that search for an matching email and hashed password*/
