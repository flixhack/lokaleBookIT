...
background-color: #ffffff;
  ...
  <input type="password" style="position:absolute;TOP:35px;left:1030px" placeholder="Kodeord" name="Password" id="Password"><br>-->
        ...
        <!-- <h1 class="h3 mb-3 font-weight-normal text-center">Opret bruger</h1> -->
            ...
            <input type="text" id="Fornavn" style="position:fixed;" class="form-control text-right" placeholder="Fornavn" required autofocus>

            <input type="text" id="Efternavn" style="position:fixed;" class="form-control text-right" placeholder="Efternavn" required autofocus>
